...
public interface ServletRequest {
     ...
     * {@link #startAsync} or
     * {@link #startAsync(javax.servlet.ServletRequest,ServletResponse)} on it.
     * 
     ...
     * {@link #startAsync(javax.servlet.ServletRequest,ServletResponse)} on this request.
     *
     * @return the AsyncContext that was created or reinitialized by the
     * most recent invocation of {@link #startAsync} or
     * {@link #startAsync(javax.servlet.ServletRequest,ServletResponse)} on
     * this request 
     *
     * @throws IllegalStateException if this request has not been put 
     * into asynchronous mode, i.e., if neither {@link #startAsync} nor
     * {@link #startAsync(javax.servlet.ServletRequest,ServletResponse)} has been called
     *
     * @since Servlet 3.0
     */
     ...
     * dispatched via {@link RequestDispatcher#forward(javax.servlet.ServletRequest,
     * ServletResponse)} or {@link RequestDispatcher#include(javax.servlet.ServletRequest,
