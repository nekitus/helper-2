...
/**
 * Java Class represntation of an {@link javax.servlet.annotation.HttpMethodConstraint} annotation value.
 *
 * @since Servlet 3.0
 */
public class HttpMethodConstraintElement extends HttpConstraintElement {
    ...
    /**
     * Constructs an instance with default {@link javax.servlet.HttpConstraintElement}
     * value.
     *
    ...
    /**
     * Constructs an instance with specified {@link javax.servlet.HttpConstraintElement}
     * value.
     *
     * @param methodName the name of an HTTP protocol method. The name must
     * not be null, or the empty string, and must be a legitimate HTTP
