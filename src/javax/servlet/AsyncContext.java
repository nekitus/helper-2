...
public interface AsyncContext {
     ...
     * <tt>Throwable</tt> available via {@link javax.servlet.AsyncEvent#getThrowable}.</li>
     * <li>If none of the listeners called {@link #complete} or any of the
     * {@link #dispatch} methods, perform an error dispatch with a status code
     ...
     * be invoked at their {@link AsyncListener#onComplete(javax.servlet.AsyncEvent)
     * onComplete} method.
     *
     ...
     * {@link AsyncListener#onComplete(javax.servlet.AsyncEvent)} will be delayed) until
     ...
     *
     * <p>The given AsyncListener will receive an {@link javax.servlet.AsyncEvent} when
     ...
     * {@link javax.servlet.AsyncEvent#getSuppliedRequest getSuppliedRequest} and
     * {@link javax.servlet.AsyncEvent#getSuppliedResponse getSuppliedResponse} methods,
     * respectively, of the {@link javax.servlet.AsyncEvent} delivered to it. These objects
