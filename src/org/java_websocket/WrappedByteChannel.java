...
public interface WrappedByteChannel extends ByteChannel {
	 ...
	 * @see #readMore(java.nio.ByteBuffer)
	 **/
	 ...
	 * This could be the case when the decoded data did not fit into the buffer the user passed to {@link #read(java.nio.ByteBuffer)}.
	 **/
